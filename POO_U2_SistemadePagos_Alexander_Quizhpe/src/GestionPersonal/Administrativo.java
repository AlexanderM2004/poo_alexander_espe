...
public class Administrativo extends Personal{
	...
	//Creacion del constructor para la clase hija Administrativo, ademas incluye variables de la clase padre Personal
	//ya que hereda datos de esta ultima clase
	public Administrativo(String nombre, int edad, long ci, int añostraba, int hijos, float sueldo, String Departamento, String titulo) {
