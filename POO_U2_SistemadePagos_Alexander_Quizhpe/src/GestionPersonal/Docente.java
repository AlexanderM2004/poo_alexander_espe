...
public class Docente extends Personal{
	...
	//Creacion del constructor para la clase hija Docente, ademas incluye variables de la clase padre Personal
	//ya que hereda datos de esta ultima clase
	public Docente(String nombre, int edad, long ci, int añostraba, int hijos, float sueldo, String Area, String titulo) {
	...
	public float PagoComisionAños(int añostraba, boolean marc) {
		...
		//Condicinal para determinar si el el ususario se puede ganar el bono estudiantil
		if(marc) {
