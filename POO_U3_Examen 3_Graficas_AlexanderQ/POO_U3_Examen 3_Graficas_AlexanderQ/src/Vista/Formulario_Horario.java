...
public class Formulario_Horario extends JInternalFrame{
    ...
    public void mostrarDatos(){
        ...
        try {
            ...
            while(rs.next()){
                ...
                registro[1] = rs.getString("lab_numlab");
                registro[2] = rs.getString("lab_nombre");
                registro[3] = rs.getString("lab_hora");
                registro[4] = rs.getString("lab_materia");
                registro[5] = rs.getString("lab_dia");
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {                                            
        String SQL = "insert into horario(lab_numlab, lab_nombre, lab_hora, lab_materia, lab_dia)values(?,?,?,?,?)";
        try {
            ...
            pst.setString(3, (String) Cmb_Hora.getItemAt(select1));
            pst.setString(4,txt_Asignatura.getText());
            pst.setString(5, (String) Cmb_Dia.getItemAt(select));
            pst.execute();
        } catch(Exception e){
            System.out.println(e);
        }
    ...
    private void EditarActionPerformed(java.awt.event.ActionEvent evt) {                                           
        ...
        try {
            String SQL = "update horario set lab_numlab =?, lab_nombre=?, lab_hora=?, lab_materia=?, lab_dia=? where lab_codigo = ?";
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {                                             
        ...
        try {
            ...
            String SQL = "delete from `horario` where lab_codigo = " + Tabla_Laboratorio.getValueAt(fila, 0);
            Statement st = (Statement) con.createStatement();
